...
mkdir -p "$installDirectory"/"iOS Application.xctemplate/HockeyApp/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Vendors/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Common/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Classes/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Controllers/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Categories/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Controls/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Views/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Resources/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Models/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Managers/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/Services/"
mkdir -p "$installDirectory"/"OS X Application.xctemplate/HockeyApp/"
